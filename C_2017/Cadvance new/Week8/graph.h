...
extern int in_degree(graph g, int vertex, int *output);		//represents the number of edges incoming to a vertex
extern int out_degree(graph g, int vertex, int *output);	//represents the number of edges outgoing from a vertex
...
extern int is_cyclic(graph g);					//given a directed graph, check whether the graph contains a cycle or not
